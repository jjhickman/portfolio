...
const PostCardImage = styled.div`
  width: auto;
  height: 200px;
  background: ${colors.whitegrey} no-repeat center center;
  background-size: cover;
...
const PostCardExcerpt = styled.section`
  ...
  @media (prefers-color-scheme: dark) {
    /* color: color(var(--whitegrey) l(+10%)); */
    color: ${lighten('0.1', colors.whitegrey)} !important;
  }
`;
...
const PostCardBylineContent = styled.div`
  ...
  margin: 4px 0 0 10px;
  /* color: color(var(--whitegrey) l(+10%)); */
  color: ${lighten('0.1', colors.whitegrey)};
  font-size: 1.2rem;
  line-height: 1.4em;
  font-weight: 400;
...
export const AuthorProfileImage = css`
  ...
  width: 100%;
  height: 100%;
  /* background: color(var(--whitegrey) l(+10%)); */
  background: ${lighten('0.1', colors.whitegrey)};
  border-radius: 100%;
  object-fit: cover;
